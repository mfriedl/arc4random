...
static void
salsa_keysetup(salsa_ctx *x,const u8 *k,u32 kbits,u32 ivbits)
{
...
static void
salsa_ivsetup(salsa_ctx *x,const u8 *iv)
{
...
static void
salsa_encrypt_bytes(salsa_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
  u8 output[64];
  int i;
